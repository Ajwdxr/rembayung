        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-400">
                        ...
                        <li class="pt-2 text-sm">
                            <span class="text-kampung-gold">Closed on Mondays</span>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-4 mt-6">
                        <a href="#" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-kampung-gold transition-colors">
            ...
            <div class="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <p class="text-gray-500 text-sm mt-2 md:mt-0">
                    Crafted with <span class="text-kampung-gold">♥</span> in Kampung Baru
                </p>
            </div>
        </div>
    </footer>
